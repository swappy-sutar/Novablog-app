                            ...
                            {notifications.length === 0 ? (
                              ...
                              notifications.map((n) => (
                                <div
                                  key={n.id}
                                  onClick={() => !n.isRead && handleMarkSingleRead(n.id)}
                                  className={`p-2.5 rounded-xl border transition-colors flex flex-col gap-1 text-left ${!n.isRead
                                      ? "bg-brand-purple/5 border-brand-purple/20 cursor-pointer hover:bg-brand-purple/10"
                                      : "bg-white/[0.01] border-transparent hover:bg-white/[0.03]"
                                    }`}
                                >
                                  <div className="flex justify-between items-start">
                                    <span
                                      className={`text-xs font-bold ${!n.isRead ? "text-white" : "text-gray-300"
                                        }`}
                                    >
                                      {n.title}
                                    </span>
