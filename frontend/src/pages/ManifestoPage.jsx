            ...
            {activeSection === "how-built" && (
              <div className="space-y-6">
                ...
                <div className="pt-4 space-y-2">
                  ...
                  <div className="p-4 rounded-xl border border-border-subtle bg-bg-card-sub font-mono text-[10px] text-text-input dark:text-emerald-400 font-semibold overflow-x-auto whitespace-pre leading-relaxed">
{`┌─────────────────────────────────────────────────────┐
│                     Client Browser                  │
