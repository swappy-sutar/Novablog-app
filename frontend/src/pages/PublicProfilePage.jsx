      ...
      <div className="relative">
        ...
        {!currentUser && (
          <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center z-20">
            <div className="max-w-md p-8 rounded-2xl bg-bg-dropdown/90 border border-border-subtle shadow-2xl backdrop-blur-xl space-y-4">
              <h3 className="text-lg font-bold text-white tracking-tight">Unlock Profile Insights</h3>
              ...
              <div className="flex justify-center gap-3 pt-2">
                <Link to="/signin">
                  <Button variant="primary" className="px-5 py-2 text-xs">Sign In</Button>
                </Link>
                <Link to="/signup">
                  <Button variant="secondary" className="px-5 py-2 text-xs">Sign Up</Button>
                </Link>
              </div>
            </div>
          </div>
